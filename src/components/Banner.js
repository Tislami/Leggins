...
const Banner = () => {
    ...
    let coverData = ["/assets/cover_1.jpg", "/assets/cover_2.jpg", "/assets/cover_3.jpg", "/assets/cover_4.jpg"];
...
const BannerButton = ({onClick, children}) => {
    return (
        <button onClick={onClick}
                className=" rounded-xl w-14 h-12 border-[1px] flex items-center justify-center hover:cursor-pointer hover:bg-gray-700 hover:text-white active:bg-gray-900 duration-300 border-gray-700">
            {children}
        </button>)
}