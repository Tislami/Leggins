...
console.log(item);
    ...
    return <div className='relative group w-72 h-[26rem] bg-white  border-[1px] pt-2 rounded-lg shadow-sm hover:scale-105 duration-500 overflow-hidden cursor-pointer  '>
...
const Title = ({title,price,category}) => { 
    return <div className='flex flex-col justify-between pt-4 bg-white'>
        ...
        <div className="group w-full pt-4 pb-2 px-4 flex flex-col gap-2 opacity-0 group-hover:opacity-100 duration-500 ">
                <div >
...
const AddToCartButton = () => { 
    return <div className='h-10 w-full absolute -bottom-10 group-hover:bottom-0 duration-500'>
        <button class="h-full w-full  bg-primary hover:bg-[#f58e34] duration-0 text-[0.75rem] text-center font-medium border rounded-b-lg flex items-center justify-center "> 
         <span>
            </span>
             Add to Cart
         </button>
